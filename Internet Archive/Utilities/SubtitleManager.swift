...
final class SubtitleManager {
    ...
    func parseLanguage(from filename: String) -> (code: String?, displayName: String, isDefault: Bool) {
        ...
        // A bare "hi" component is skipped: by convention it marks
        // hearing-impaired (closed caption) subtitles, not Hindi.
        // Unambiguous Hindi tokens like "hindi" or "hin" still match.
        for component in components.reversed() where component != "hi" {
